...
issues = empty;
tempVar = empty;
stepParameters = empty;
mainParameters = empty
 ...
 */
summaryCountTests = empty;
passedCountTests = empty;
failedCountTests = empty;
skippedCountTests = empty;
